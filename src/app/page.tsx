  ...
  return (
    <>
      <Image
        ...
        alt="background"
      />
      <main className="bg-[#0009] absolute z-auto flex-col  w-screen h-screen flex justify-center items-center">
        <div className="flex flex-col justify-center items-center gap-4 w-[50%] max-sm:w-[100%] bg-zinc-800 p-4 rounded-md">
          ...
          <button
            ...
            className="bg-[#005B41] flex rounded-md text-white font-bold justify-center items-center p-2 w-full hover:bg-[#005B50]"
          >
            Entrar
          </button>
          <button
            onClick={() => push('/signup')}
            className="text-white hover:text-[#005B41]"
          >
            Cadastre-se
          </button>
        </div>
